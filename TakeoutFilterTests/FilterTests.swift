...
class FilterTests: XCTestCase {
    ...
    func testJsonFilter() {
        ...
        let result = instance.filterQueries(content: jsonContent, presentationDate: Date(timeIntervalSinceReferenceDate: 698000000), namesToFilter: "Forename Surname")
    ...
    func testHtmlFilter() {
        ...
        let result = instance.filterQueries(content: htmlContent, presentationDate: Date(timeIntervalSinceReferenceDate: 698000000), namesToFilter: "Forename Surname")
        XCTAssertEqual(result.outcome, .success)
